...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Movement.WorldPosition worldPosition { get { return (Code.Gameplay.Features.Movement.WorldPosition)GetComponent(GameComponentsLookup.WorldPosition); } }
    ...
    public GameEntity AddWorldPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.Gameplay.Features.Movement.WorldPosition)CreateComponent(index, typeof(Code.Gameplay.Features.Movement.WorldPosition));
