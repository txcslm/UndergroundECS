...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Cooldown.CooldownLeft cooldownLeft { get { return (Code.Gameplay.Features.Cooldown.CooldownLeft)GetComponent(GameComponentsLookup.CooldownLeft); } }
    ...
    public GameEntity AddCooldownLeft(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Cooldown.CooldownLeft)CreateComponent(index, typeof(Code.Gameplay.Features.Cooldown.CooldownLeft));
