...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Cooldown.Cooldown cooldown { get { return (Code.Gameplay.Features.Cooldown.Cooldown)GetComponent(GameComponentsLookup.Cooldown); } }
    ...
    public GameEntity AddCooldown(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Cooldown.Cooldown)CreateComponent(index, typeof(Code.Gameplay.Features.Cooldown.Cooldown));
